...
//					}
	...
	/*
	int isHandopen(){
		if(Hand_Tip_Left==null || Hand_Left==null)
		{
			Debug.Log ("null");
			return 0;
		}

		//float sqrdistance_hand_thumb = (Hand_Left.transform.position - Thumb_Left.transform.position).sqrMagnitude;
		...
		{
			//Debug.Log (sqrdistance_hand_thumb+"  "+sqrdistance_hand_handtip);
			//Debug.Log ("2  "+sqrdistance_hand_handtip);
			return 2;
		}
	}
	*/
	...
	//閉じている場合は手の座標を返す
	public int isLHandopen(){
		if(Hand_Tip_Right==null || Hand_Right==null)
		{
			Debug.Log ("null");
			return 0;
		}
